...
export const displayController = async (req: CustomRequest, res: Response) => {
  res.json(
    await findAllModels(
      Product,
      ['id', 'title', 'price'],
...
export const buyController = async (req: CustomRequest, res: Response) => {
...
export const createController = async (req: CustomRequest, res: Response) => {
  try {
...
export const editController = async (req: CustomRequest, res: Response) => {
  try {
